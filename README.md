...
Note that for future version management and to distinguish it from the Ver.2.7 series, Mass++ Ver.4 Gold has been renamed to Mass++4 Ver.1.0.0. We will primarily use this name going forward.
...
なお、今後のバージョン管理とVer.2.7系列との区別のために、Mass++ Ver.4 GoldはMass++4 Ver.1.0.0と改称しました。今後はこちらの名称を主に使用してきます。
